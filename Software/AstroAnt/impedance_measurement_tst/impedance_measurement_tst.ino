...
unsigned long FREQ_INCR  = 1000;
const int NUM_INCR = 1;
...
byte * frequencySweepEasy() {
  ...
  if (AD5933::frequencySweep(real, imag, NUM_INCR+1)) {
    for (int iii = 0; iii < NUM_INCR+1; iii++) {
      ...
      impedance[iii] = 1/(magnitude*gain[iii]);

      // impedance_b = (byte *) &impedance[0];
    }
